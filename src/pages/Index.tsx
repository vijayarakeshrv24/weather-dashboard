...
const Index = () => {
  return (
    <div
      className="min-h-screen bg-cover bg-center text-foreground transition-colors duration-700"
      style={{
        backgroundImage: `url('https://img.freepik.com/free-photo/beautiful-colorful-sunset_1048-2416.jpg')`,
      }}
    >
      {/* Overlay (optional, to darken/lighten background slightly) */}
      <div className="min-h-screen bg-white/30 dark:bg-black/30 backdrop-blur-sm">
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-14 pb-20">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
            {/* Weather Card */}
            <section className="lg:col-span-2 animate-slide-up animate-swing rounded-3xl shadow-2xl backdrop-blur-lg p-6">
              <WeatherCard />
            </section>

            {/* 5-Day Forecast */}
            <aside className="lg:col-span-1 animate-slide-up animate-swing rounded-3xl shadow-2xl backdrop-blur-lg p-6">
              <FiveDayForecast />
            </aside>
          </div>

          {/* Hourly Forecast */}
          <section className="animate-slide-up animate-swing rounded-3xl shadow-2xl backdrop-blur-lg p-6">
            <HourlyForecast />
          </section>
        </main>
      </div>
